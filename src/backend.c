...
void generate_source_kernel_filename (const bool slow_candidates, const u32 attack_exec, const u32 attack_kern, const u32 kern_type, const u32 opti_type, char *shared_dir, char *source_file/*, bool is_cuda*/)
{
...
void generate_source_kernel_filename_cuda (const bool slow_candidates, const u32 attack_exec, const u32 attack_kern, const u32 kern_type, const u32 opti_type, char *shared_dir, char *source_file/*, bool is_cuda*/)
{
  if (opti_type & OPTI_TYPE_OPTIMIZED_KERNEL)
  {
    if (attack_exec == ATTACK_EXEC_INSIDE_KERNEL)
  ...
  for (int backend_devices_idx = 0; backend_devices_idx < backend_ctx->backend_devices_cnt; backend_devices_idx++)
  {
    ...
    */
...

    {
      ...
      char source_file[256] = { 0 };
      if (device_param->is_cuda == true && (kern_type == 1400 || kern_type == 0)){
